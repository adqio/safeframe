...
(function() {
  (function(win) {
    var AUTO_BOOT_MAX_RETRIES, FALSE, NULL, SF_DATATAG_CLASS, SF_POSELEM_WRAPPER_CLASS, SF_TAG_TYPE, TRUE, boot, boot_retries, d, doing_auto_boot, dom, has_booted, inline_tags_processed, lang, lib, sf, _attr, _auto_boot, _clean_up_booted_tags, _create_pos_markup, _cstr, _elt, _guid, _log, _par, _purge, _ready, _tags;
    ...
    has_booted = FALSE;
    doing_auto_boot = FALSE;
    return setTimeout(_auto_boot, 50);
  })(window);
