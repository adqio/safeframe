...
(function() {
  define(function() {
    var ParamHash, backSlash, callable, cbool, cnum, cstr, def, guid, isArray, jssafe_html, mix, next_id, noop, ns, proto, rand, scrip_str, time, toString, trim, win, _es, _escaped_backslash, _escaped_dbl_quote, _escaped_new_line, _escaped_return, _safe_script_tag, _ue;
    next_id = 0;
    win = window;
     ...
     */
    cbool = function(val) {
      return !val || [void 0, "0", "false", "no", "undefined", "null", null].indexOf(val) >= 0;
    };
    ...
    @private
     */
    _safe_script_tag = function(main_match, back_slash, attrs) {
