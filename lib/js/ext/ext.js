...
(function() {
  ...
  module.exports = function(isExternal, canNest) {
    return (function(window, sf) {
        ...
        document.write = function(str) {
          ...
          if (!(hasLoaded || otherCallbackApplied)) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              iframe = _ref[_i];
              if (_cnum(_attr(iframe, "width"), 0) > 1 || _cnum(iframe.style.width) > 1) {
      ...
      _send_msg = function(str, cmd) {
        ...
        if (can_use_html5) {
          try {
            window.parent.postMessage(params.toString(), (host_cname === "file" || host_cname === "" ? "*" : host_cname));
            sent = true;
          } catch (_error) {
            e = _error;
            sent = false;
